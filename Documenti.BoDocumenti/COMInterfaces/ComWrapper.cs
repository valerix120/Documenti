...
namespace Documenti.Interop
{
    ...
    /// </summary>
    internal sealed class COMWrapper : RealProxy, IDisposable
    {
        #region Private Data
        ...
        /// <remarks>
        /// The <typeparamref name="T"/> must be an interface decorated with
        ...
        private void Dispose(bool disposing)
        {
            if (disposing)
            {
                if (this._ComEventProvider != null)
                {
        ...
        public override bool Equals(object value)
        {
            if (value != null && RemotingServices.IsTransparentProxy(value))
            {
                ...
                if (wrapper != null) return this._COMObject == wrapper._COMObject;
            }
